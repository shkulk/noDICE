...
def nordhaus_policy(sr = 0, prtp_con = 0,prtp_dam=0, periodfullpart =  0, miu_period = 0) :
    
    '''Specify levers for further usage'''
    
    levers_param = {'sr': sr, 'prtp con': prtp_con,'periodfullpart': periodfullpart, 'miu_period': miu_period}
